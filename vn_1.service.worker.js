...
/** @type {string} */
const CACHE_VERSION = '1758062809|53349414574';
/** @type {string} */
const CACHE_PREFIX = 'vn_tuto_1-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'vn_1.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = false;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["vn_1.html","vn_1.js","vn_1.offline.html","vn_1.icon.png","vn_1.apple-touch-icon.png","vn_1.audio.worklet.js","vn_1.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["vn_1.wasm","vn_1.pck"];
